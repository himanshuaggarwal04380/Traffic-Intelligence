...
Understand historical traffic behavior.

Identify temporal and seasonal patterns.

Prepare traffic data for time-series analysis.

Compare different statistical and machine-learning approaches.

Evaluate model results using MAE, RMSE and MAPE.

Analyze model errors and residuals.

Build an interactive application for presenting the results.
...
Check missing values and time gaps.

Aggregate hourly traffic into a daily series.

Prepare a continuous series for analysis.

Apply transformations required by individual models.
